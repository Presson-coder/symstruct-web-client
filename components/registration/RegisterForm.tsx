...
const RegisterForm = () => {
  ...
  return (
    <div>
      <div>
        <div className="relative flex min-h-screen items-center justify-center bg-[url('/registerImage.jpg')] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
